...
The training arguments follow the [PyTorch Image Classification reference training scripts](https://github.com/pytorch/vision/blob/v0.13.0-rc4/references/classification/README.md). you can specify the direction given below in the `pytorch/distributed-training/values.yaml` file.
...
Reference training scripts for image classification.
